...
El límite no está tanto en la técnica manual en sí (muchas técnicas se solapan: piedras calientes, deportivo, tailandés se pueden dar en ambos registros) sino en **cómo se comunica y vende el servicio**:

- ✅ "Masaje relajante con piedras calientes", "masaje deportivo de bienestar" → sin problema regulatorio.
- ❌ Anunciar el servicio como que "trata" contracturas, lesiones, dolor crónico, o cualquier lenguaje que prometa un efecto terapéutico/médico → cruza la línea hacia intrusismo, independientemente de la técnica usada.

Esto es relevante también para el **marketing** del salón (rótulos, redes sociales, carta de servicios): conviene que la propietaria sea consciente de este límite al describir los masajes que ofrezcan sus autónomas, no solo al contratarlas.
...
- [Masaje terapéutico e intrusismo — Colegio Oficial de Fisioterapeutas de la Comunidad Valenciana](https://colfisiocv.com/node/21112)
- [Masaje terapéutico: qué es, tipos y diferencias con otros masajes — Fisioterapia Online](https://www.fisioterapia-online.com/articulos/masaje-terapeutico-que-es-tipos-y-diferencias-con-otros-masajes)

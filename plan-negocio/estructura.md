...
Sigue siendo la sección más bloqueada, pero ahora tiene desarrollo propio en [`financiero.md`](./financiero.md) (ingresos, costes, punto de equilibrio y escenarios): dos cifras reales de ingresos por alquiler — 300 €/mes (salón central, ya en marcha) y ~400 €/mes objetivo por cada uno de los 2 cubículos, ver [`precios-servicios.md`](../negocio/precios-servicios.md) — dan un ingreso potencial a pleno rendimiento del orden de **1.100 €/mes** (300 + 400 + 400). Ese documento añade además un matiz nuevo: no está claro si esos ~400 €/mes son importe bruto de factura o neto a cobrar, lo que cambia el ingreso real más de un 15% por el efecto combinado de IVA (21%) y retención de IRPF (19%) — ver [`tramites-administrativos.md`](../negocio/tramites-administrativos.md#4-iva-e-irpf-del-alquiler-de-las-cabinas). Sigue faltando, por este orden de impacto:

...
- [ ] Perfil del cliente tipo (edad, poder adquisitivo, residente/turista).
- [ ] Estacionalidad (impacto del turismo en Las Galletas).
...
- [ ] **Facturación propia actual de la propietaria ejerciendo como esteticista** — es el dato que decide si el cambio de modelo mejora o empeora sus ingresos, no solo un dato más del plan económico. Ver [`../plan-negocio/financiero.md`](../plan-negocio/financiero.md#41-la-comparación-que-falta-el-plan-frente-a-seguir-como-hasta-ahora).
- [ ] **Si los ~400 €/mes objetivo de cada cubículo son base de factura o cobro en cuenta** — un 12% de diferencia de caja por el efecto de la retención de IRPF (19%) y del IGIC (7%, si no se acoge al REPEP). Ver [`tramites-administrativos.md`](./tramites-administrativos.md#4-igic-e-irpf-del-alquiler-de-las-cabinas).
...
- [ ] ¿Qué motiva la diversificación? (crecer ingresos, ocupar tiempos muertos, diferenciarse de la competencia...)
- [x] **Decisión tomada**: La gestora reconvierte el salón en un **espacio de coworking de belleza** — ella pasa a ser propietaria/gestora del espacio, deja de ejercer como esteticista y alquila el salón central (ya ocupado, 300 €/mes) y los 2 cubículos del fondo (objetivo ~400 €/mes cada uno, sin obra). Detalle en [`diversificacion.md`](./diversificacion.md).
- [ ] ¿Es 400 €/mes un precio ya cerrado para los cubículos, o todavía en estudio?
- [ ] Qué incluye el alquiler de cada cubículo (equipamiento, recepción/agenda, suministros, limpieza).
- [ ] Perfil de profesionales que la propietaria quiere para los 2 cubículos (¿uno debe seguir con estética/depilación para dar continuidad a su cartera?).

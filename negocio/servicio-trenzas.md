# Ficha: servicio de trenzas (box braids / trenzas afro)

Uno de los servicios propuestos para ocupar una de las cabinas nuevas si se amplía el local (ver [`diversificacion.md`](./diversificacion.md)). Evidencia de demanda: turista alojada en Las Galletas preguntando explícitamente dónde hacérselo, sin encontrarlo en el pueblo ([hilo Tripadvisor](https://www.tripadvisor.co.uk/ShowTopic-g187479-i153-k10795564-o30-Hair_braiding-Tenerife_Canary_Islands.html)).
...
- Certificado de instalación eléctrica con el código de actividad.
- Certificado de instalación contra incendios (normalmente extintores) y contrato de mantenimiento.
- Seguro de responsabilidad civil.

**Importante para el caso de la propietaria**: esto es lo que hace falta para abrir un local nuevo desde cero. Como el salón ya está abierto y licenciado, la pregunta real es si la licencia actual cubre que una nueva autónoma (trenzas) opere en una cabina adicional del mismo local, o si hace falta ampliar/modificar la licencia existente — esto ya está anotado como pregunta abierta en [`diversificacion.md`](./diversificacion.md#preguntas-abiertas-para-la-propietaria) y hay que confirmarlo directamente con el Ayuntamiento de Arona, no se puede resolver por búsqueda web.

### 3. Titulación profesional de quien hace las trenzas — punto con información contradictoria, sin resolver
...
- [Ser peluquero sin título: ¿es posible? — Campus Training](https://www.campustraining.es/noticias/puede-ser-peluquero-tener-titulo/)
